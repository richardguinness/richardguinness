...
| 🦀 **Rust/WASM MNIST trainer** | Browser-based neural-network trainer with Rust compiled to WebAssembly. | Rust numerical core; `wasm-bindgen`; Web Worker training; configurable MNIST training UI; metrics; model import/export; canvas digit prediction. | [Public repo](https://github.com/richardguinness/sandbox-rustwasm) |
